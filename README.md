...
- [Запуск тестов в Jenkins и из терминала](#запуск-тестов-в-jenkins-и-из-терминала)
- [Allure-отчет](#allure-отчет)
- [Интеграция с Allure-TestOps](#интеграция-с-allure-testops)
- [Уведомление в Telegram о результатах прогона тестов](#уведомление-в-telegram-о-результатах-прогона-тестов)
- [Примеры видео выполнения web тестов в Selenoid](#примеры-видео-выполнения-web-тестов-в-selenoid)
- [Примеры видео выполнения мобильных тестов в BrowserStack](#примеры-видео-выполнения-мобильных-тестов-в-browserstack)
